"""
System-Level Windows Jiggler v1.2
Works with hardware switching setups - No mouse dependency!

This version uses Windows system calls instead of mouse movements
to prevent the system from going to sleep, making it hardware-switch safe.
"""
